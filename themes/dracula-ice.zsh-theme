...
PROMPT='%(1V:%F{yellow}:%(?:%F{34}:%F{red}))${DRACULA_ARROW_ICON}'
# }}}
...
PROMPT+='%F{$TIME_COLOR}%B$(dracula_time_segment) '
# }}}
...
PROMPT+='%F{$USER_COLOR}%B$(dracula_context)'
# }}}

# Directory segment {{{
PROMPT+='%F{$DIR_COLOR}%B%~ '
# }}}
...
ZSH_THEME_GIT_PROMPT_PREFIX="%F{$GIT_COLOR}%B("
